...
class AutonanaApp(Application):
    ...
    light       = 300.0, 300.0, 300.0     # light source position
    ...
    def __init__(self,mod,tex=None):
        ...
        self.set_perspective_projection(self.fov, 0.05, 1000.0)          # use perspective projection for rendering (float fieldOfView, float aspectRatio, float nearPlane, float farPlane)
